...
import adminIllustration from "../assets/images/Professor.svg";
...
const LecturerAuth = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-100 to-sky-200 flex flex-col items-center justify-between relative overflow-hidden">
        ...
        >
          <div className="relative max-w-md">
            ...
            {[1, 2, 3].map((i) => (
              <motion.div
                key={i}
                className="absolute bg-sky-100/30 backdrop-blur-md p-3 rounded-full border border-sky-300/50"
                style={{
        ...
        >
          <Card className="bg-white/5 backdrop-blur-md border border-sky-200/50 shadow-2xl rounded-2xl overflow-hidden">
            <CardHeader className="pb-4 text-center">
              ...
              >
                <div className="bg-sky-500 p-3 rounded-full inline-flex items-center justify-center">
            ...
            <CardContent className="p-6">
              <Tabs defaultValue="login" className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-6 bg-sky-50/50 rounded-lg p-1">
                  <TabsTrigger
                    value="login"
                    className="data-[state=active]:bg-white data-[state=active]:shadow-sm text-gray-700 hover:text-sky-600"
                  >
                    Login
                  </TabsTrigger>
                  <TabsTrigger
                  ...
                  >
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="block w-full pl-4 pr-4 py-3 bg-white/50 backdrop-blur-sm border border-sky-300/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent text-gray-800 placeholder-gray-400 transition-all"
                      />
                    </div>
                  </motion.div>
                  <motion.div
                  ...
                  >
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="block w-full pl-4 pr-10 py-3 bg-white/50 backdrop-blur-sm border border-sky-300/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent text-gray-800 placeholder-gray-400 transition-all"
                      />
                      <button
                        type="button"
